...
import { SUITS, CARD_VALUES, MAX_INITIAL_KINGS } from './constants';

/**
 * Step 3.1: Create a full 40-card Italian deck.
...
/**
 * Step 3.2: Shuffle a deck using Fisher-Yates algorithm.
...
/**
 * Step 3.3: Deal cards from the top of the deck.
...
/**
 * Step 3.4: Validate initial table deal (must not have 3+ kings).
